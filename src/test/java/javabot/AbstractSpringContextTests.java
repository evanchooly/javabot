...
public abstract class AbstractSpringContextTests {
   ...
   */
  private static final Map<Object, ConfigurableApplicationContext> contextKeyToContextMap = new HashMap<Object, ConfigurableApplicationContext>();
...
//    String keyString = contextKeyString(key);
    ConfigurableApplicationContext ctx =
        contextKeyToContextMap.get(key);
    if (ctx == null) {
      ctx = loadContext(key);
