...
class KarmaOperationTest @Inject constructor(val nickServDao: NickServDao, val karmaDao: KarmaDao, val operation: KarmaOperation) :
        BaseTest() {
    ...
    fun queryOwnKarma() {
        ...
        val response = operation.handleMessage(message("~karma bill", bill))
