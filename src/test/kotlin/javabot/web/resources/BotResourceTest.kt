...
class BotResourceTest : BaseTest() {
    ...
    @Inject lateinit var application: JavabotApplication

    private var client = HttpClient.newHttpClient()

    @Inject lateinit var javabotConfig: JavabotConfig

    @Inject lateinit var configuration: JavabotConfiguration
