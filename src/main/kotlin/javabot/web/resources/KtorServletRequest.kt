...
/**
 * Adapter class to make Ktor ApplicationCall work like HttpServletRequest Only implements the
...
class KtorServletRequest(private val call: ApplicationCall) : HttpServletRequest {
    ...
    private class DummySession : HttpSession {
        ...
        fun getServletContext(): ServletContext? = null
        ...
        @Deprecated("Deprecated") override fun getSessionContext(): HttpSessionContext? = null

        @Deprecated("Deprecated") override fun getValue(name: String?): Any? = getAttribute(name)
        ...
        @Deprecated("Deprecated") override fun removeValue(name: String?) = removeAttribute(name)
    }
    ...
    override fun getHeaderNames(): Enumeration<String> =
        Collections.enumeration(call.request.headers.names())

    override fun getHeaders(name: String?): Enumeration<String> =
        Collections.enumeration(call.request.headers.getAll(name ?: "") ?: emptyList())
    ...
    @Deprecated("Deprecated") override fun isRequestedSessionIdFromUrl(): Boolean = false

    override fun isRequestedSessionIdValid(): Boolean = false

    override fun isUserInRole(role: String?): Boolean = false

    fun authenticate(response: HttpServletResponse?): Boolean = false
    ...
    fun getParts(): MutableCollection<Part> = mutableListOf()

    fun getPart(name: String?): Part? = null
    ...
    fun getContentLengthLong(): Long = -1

    override fun getContentType(): String? = call.request.contentType().toString()

    override fun getInputStream(): ServletInputStream = TODO()

    fun getLocalAddr(): String = ""

    fun getLocalName(): String = ""

    fun getLocalPort(): Int = 0

    override fun getLocale(): Locale = Locale.getDefault()

    override fun getLocales(): Enumeration<Locale> =
        Collections.enumeration(listOf(Locale.getDefault()))

    override fun getParameterNames(): Enumeration<String> =
        Collections.enumeration(call.request.queryParameters.names())

    override fun getParameterValues(name: String?): Array<String>? =
        call.request.queryParameters.getAll(name)?.toTypedArray()
    ...
    fun getRemotePort(): Int = call.request.local.remotePort
    ...
    fun isAsyncStarted(): Boolean = false

    fun isAsyncSupported(): Boolean = false
    ...
    fun startAsync(): AsyncContext = TODO()
    ...
    fun getDispatcherType(): DispatcherType = DispatcherType.REQUEST
}
