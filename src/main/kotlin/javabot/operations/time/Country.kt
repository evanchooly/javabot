...
public enum class Country {
    ...
    ANTARCTICA("Antarctica", "AQ", TimezonesAntarctica()),
    ...
    AUSTRALIA("Australia", "AU", TimezonesAustralia()),
    ...
    BRAZIL("Brazil", "BR", TimezonesBrazil()),
    ...
    CANADA("Canada", "CA", TimezonesCanada()),
    ...
    ECUADOR("Ecuador", "EC", TimezonesEcuador()),
    ...
    GREENLAND("Greenland", "GL", TimezonesGreenland()),
    ...
    INDONESIA("Indonesia", "ID", TimezonesIndonesia()),
    ...
    MEXICO("Mexico", "MX", TimezonesMexico()),
    MOLDOVA("Moldova", "MD", "Europe/Chisinau"),
    MONACO("Monaco", "MC", "Europe/Monaco"),
    MONGOLIA("Mongolia", "MN", TimezonesMongolia()),
    ...
    PORTUGAL("Portugal", "PT", TimezonesPortugal()),
    ...
    RUSSIA("Russia", "RU", TimezonesRussia()),
    ...
    UNITED_STATES("United States", "US", TimezonesUS()),
    ...
    public val multiZones: Timezones?


    constructor(name: String, abbreviation: String, timezone: String) {
        this.name = name
    ...
    constructor(name: String, abbreviation: String, multiZones: Timezones) {
        this.name = name
        this.abbreviation = abbreviation
        this.timezone = null
    ...
    public fun isMultiZones(): Boolean {
