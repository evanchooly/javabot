...
/**
 * Reusable user sign in panel with username and password as well as support for cookie persistence of the both. When
 * the SignInPanel's form is submitted, the abstract method signIn(String, String) is called, passing the username and
 * password submitted. The signIn() method should sign the user in and return null if no error ocurred, or a descriptive
 * String in the event that the sign in fails. <p/> s * @author Jonathan Locke
 *
...
public abstract class SignInPanel extends Panel {
     ...
     * @param remember True if form should include a remember-me checkbox
     *
     * @see Component#Component(String)
     */
    public SignInPanel(String id, boolean remember) {
        super(id);
        includeRememberMe = remember;
     ...
     */
    public abstract boolean signIn(String user, String pwd);
}
